...
# --- JAZZMIN SETTINGS (Global UI Overhaul) ---
JAZZMIN_SETTINGS = {
    "site_title": "FarmAid Admin",
    "site_header": "FarmAid",
    "site_brand": "FarmAid Lesotho",
    "welcome_sign": "Welcome to FarmAid Management",
    "copyright": "FarmAid Lesotho 2026",
    "user_avatar": None,
    
    # 1. Uniform Card logic + Global Polish
    "custom_css": "api/css/admin_master.css",
    ...
    # Grid Logic: Ensures 4 items for symmetrical card display
    "order_with_respect_to": [
        "admin.LogEntry", 
        "api.Farmer", 
        "api.Diagnosis", 
    ...
    "icons": {
        "admin.LogEntry": "fas fa-history",
        "auth": "fas fa-users-cog",
        "api.Farmer": "fas fa-users",
        "api.Plant": "fas fa-leaf",
        "api.Diagnosis": "fas fa-microscope",
        "api.Alert": "fas fa-bell",
    },
}

JAZZMIN_UI_TWEAKS = {
    "theme": "flatly", # Clean, modern Bootstrap theme
    "brand_colour": "navbar-success",
