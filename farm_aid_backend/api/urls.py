...
from .views import (
    ...
    DiagnosisListView,
    PlantListView,
    # Spicy MarianMT Translation
    spicy_translate,
    spicy_batch_translate,
    spicy_cache_stats,
    spicy_health,
)
...
urlpatterns = [
    ...
    # ── 16. SPICY MARIANMT TRANSLATION ENDPOINTS ────────────────────────────
    path('spicy/translate/',                 spicy_translate,               name='spicy_translate'),
    path('spicy/batch/',                     spicy_batch_translate,         name='spicy_batch_translate'),
    path('spicy/stats/',                     spicy_cache_stats,             name='spicy_cache_stats'),
    path('spicy/health/',                    spicy_health,                  name='spicy_health'),
]
