...
#     """
#     Core user model. experience_level drives advice complexity.
...
#         help_text="Controls advice language — beginner gets plain language, expert gets technical protocols"
#     )
...
#     """
#     One growing season for one vegetable. The richer this data,
#     the more accurate the PersonalizedRule matching becomes.
#     """
#     SOIL_CHOICES = [
#         ('sandy', 'Sandy'),
#         ('clay', 'Clay'),
...
#     SoilEnvironment = models.CharField(
#         max_length=20, choices=SOIL_CHOICES, blank=True, null=True,
#         help_text="Standardized soil type — critical for accurate disease rule matching"
#     )
#     PlantingDate = models.DateField(blank=True, null=True)
#     IsActive = models.BooleanField(default=True)
#     CreatedAt = models.DateTimeField(auto_now_add=True)

#     # Agronomic details for personalization
...
#         max_length=20, choices=IRRIGATION_CHOICES, default='rain'
#     )
#     seed_variety = models.CharField(
#         max_length=100, blank=True, null=True,
#         help_text="e.g., 'Roma VF' — some varieties carry disease resistance"
#     )
...
#     # --- Live GPS captured at scan time ---
#     latitude = models.FloatField(
#         blank=True, null=True,
#         help_text="Live GPS latitude captured when farmer scanned the crop"
#     )
#     longitude = models.FloatField(
#         blank=True, null=True,
#         help_text="Live GPS longitude captured when farmer scanned the crop"
#     )
#     altitude_meters = models.FloatField(
#         blank=True, null=True,
#         help_text="Altitude from geolocator — affects microclimate and disease risk"
#     )
#     gps_district = models.CharField(
#         max_length=100, blank=True, null=True,
#         help_text="Reverse-geocoded district name from GPS coordinates"
#     )
...
# # ============================================================
# # --- 4. DIAGNOSIS TABLE (with feedback loop) ---
# # ============================================================
...
#     rainfall_last_7_days = models.FloatField(
#         default=0.0,
#         help_text="Weekly rainfall total — high values spike fungal disease rules"
#     )
...
# # ============================================================
# # --- 10. PERSONALIZED RULE ENGINE (8-Factor) ---
# # ============================================================
# class PersonalizedRule(models.Model):
#     """
#     The heart of FarmAid's intelligence. Each rule fires ONLY
#     when ALL specified conditions match the farmer's real context.
#     Null fields = 'match any' so rules can be broad or hyper-specific.

#     Matching priority order (most specific wins):
#       1. Disease detected        — required, from AI/Gemini
#       2. Live GPS district       — from geolocator at scan time
#       3. Soil type               — from CropProfile
#       4. Irrigation method       — from CropProfile
#       5. Growth stage            — calculated from PlantingDate
#       6. Crop variety            — from CropProfile
#       7. Season                  — auto from scan date (wet/dry)
#       8. Recent rainfall level   — from WeatherData
#     """
...
#     # TRIGGER 1: Disease (required)
#     DiseaseName = models.CharField(
#         max_length=255,
#         help_text="Must match the AI/Gemini diagnosis output exactly"
#     )

#     # TRIGGER 2: Live GPS district
#     TriggerDistrict = models.CharField(
#         max_length=100, blank=True, null=True,
#         help_text="District from live GPS at scan time. Null = all districts."
#     )

#     # TRIGGER 3: Soil type
#     TriggerSoilType = models.CharField(
#         max_length=20, choices=SOIL_CHOICES, blank=True, null=True,
#         help_text="Null = all soil types. Clay = high fungal risk. Sandy = high nutrient loss."
#     )

#     # TRIGGER 4: Irrigation method
#     TriggerIrrigation = models.CharField(
#         max_length=20, choices=IRRIGATION_CHOICES, blank=True, null=True,
#         help_text="Sprinkler keeps leaves wet — raises fungal disease risk significantly"
#     )

#     # TRIGGER 5: Growth stage window
#     MinDaysSincePlanting = models.IntegerField(
#         default=0,
#         help_text="Start of growth stage window (0 = seedling)"
#     )
#     MaxDaysSincePlanting = models.IntegerField(
#         default=999,
#         help_text="End of growth stage window (999 = any stage)"
#     )

#     # TRIGGER 6: Crop variety
#     TriggerCropVariety = models.CharField(
#         max_length=100, blank=True, null=True,
#         help_text="e.g., Roma VF has blight resistance — advice differs from standard varieties"
#     )

#     # TRIGGER 7: Season
#     TriggerSeason = models.CharField(
#         max_length=10, choices=SEASON_CHOICES, default='any',
#         help_text="Dry season = water stress diseases. Wet season = fungal/bacterial diseases."
#     )

#     # TRIGGER 8: Recent rainfall level
#     TriggerRainfallLevel = models.CharField(
#         max_length=10, choices=RAINFALL_LEVEL_CHOICES, default='any',
#         help_text="High recent rainfall spikes fungal and bacterial disease risk"
#     )

#     # Expert advice output
#     ExpertAdvice = models.TextField(
#         help_text="Full technical advice for intermediate/expert farmers"
#     )
#     advice_beginner = models.TextField(
#         blank=True, null=True,
#         help_text="Plain-language version for beginner farmers"
#     )
#     RecommendationCategory = models.CharField(
#         max_length=50, default="General",
#         help_text="e.g., Fungicide, Irrigation, Nutrition, Harvesting, Soil Amendment"
#     )

#     # Higher score = more specific rule = wins over general rules
#     priority_score = models.IntegerField(
#         default=1,
#         help_text="Increase for highly specific rules so they override general ones"
#     )

#     class Meta:
#         indexes = [
#             models.Index(fields=['DiseaseName', 'TriggerDistrict', 'TriggerSoilType']),
...
#         if self.TriggerDistrict:
#             parts.append(self.TriggerDistrict)
#         if self.TriggerSoilType:
#             parts.append(self.TriggerSoilType)
#         if self.TriggerSeason != 'any':
#             parts.append(self.TriggerSeason)
...
#     """
#     Call this after every diagnosis to find the best-matching
#     personalized advice for this specific farmer's full context.

#     Example usage in your Django view after a scan:

#         advice = RuleMatchingService.get_best_match(
...
#         # {
#         #   "found": True,
#         #   "advice": "Your clay soil is retaining moisture after heavy rain...",
#         #   "category": "Fungicide",
#         #   "matched_on": { "district": "Maseru", "soil": "clay", ... }
#         # }
#     """

#     # Lesotho season map by month
#     SEASON_MAP = {
...
#     @staticmethod
#     def _classify_rainfall(mm_per_week: float) -> str:
#         if mm_per_week < 10:
#             return 'low'
#         elif mm_per_week <= 30:
#             return 'moderate'
...
#         crop_profile,    # CropProfile instance
#         gps_district: str,
...
#         # AND logic: all specified triggers must match.
#         # Null trigger fields on a rule = wildcard (match any value).
#         matching_rules = PersonalizedRule.objects.filter(
#             Q(DiseaseName__iexact=disease_name)
#             & (Q(TriggerDistrict=gps_district)                          | Q(TriggerDistrict__isnull=True))
...
#         # Deliver simpler language to beginner farmers
...
# # ============================================================
# # --- 12. FARMER INSIGHT (Personalized Analytics) ---
# # ============================================================
# class FarmerInsight(models.Model):
#     """
#     Updated after every scan. Powers dashboard cards like:
#     'Your most common disease is Early Blight'
#     'Tomatoes are your highest-risk crop'
#     'You have a 14-day healthy streak'
#     """
