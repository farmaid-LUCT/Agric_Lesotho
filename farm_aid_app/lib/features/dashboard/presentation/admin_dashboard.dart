...
class _AdminDashboardState extends State<AdminDashboard>
  ...
  // Keep only needed fields for insights
  String _topDisease = '—';
  String _topDistrict = '—';
  int _totalScans = 0;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInsightRow(),
              const SizedBox(height: 24),
              // QUICK ACTIONS - NO DASHBOARD CARD HERE
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'FarmAid is running · $_totalScans total scans recorded',
                  style: TextStyle(
  ...
  // QUICK ACTIONS - NO DASHBOARD CARD
