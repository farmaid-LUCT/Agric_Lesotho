...
// import 'package:farm_aid_app/features/history/presentation/widgets/trend_chart.dart';
// import 'package:farm_aid_app/features/history/data/analytics_service.dart';
...
//       double confidence =
//           double.tryParse(item['Confidence']?.toString() ?? '1.0') ?? 1.0;
...
//       appBar: AppBar(
//         title: Text(
//           appLoc?.translate('Vegetable Insights') ?? 'Vegetable Insights',
//           style: TextStyle(
...
//                             isDark, appLoc, trendData),
//                       ),
//                     )
//                   // ── MOBILE: full width ─────────────────────────
//                   : _buildScrollContent(isDark, appLoc, trendData),
//     );
//   }
...
//                 trendData.last['risk'], isDark, appLoc),
...
//       double risk, bool isDark, AppLocalizations? appLoc) {
//     final bool isHigh = risk > 0.6;
//     return Container(
//       padding: const EdgeInsets.all(16),
//       decoration: BoxDecoration(
//         color: isHigh
...
//         children: [
//           Icon(
//             isHigh ? Icons.warning : Icons.health_and_safety,
...
//             child: Text(
//               isHigh
//                   ? (appLoc?.translate('predictive_high') ??
//                       'Alert: Recent patterns suggest a localized disease spike. Monitor humidity levels.')
//                   : (appLoc?.translate('predictive_low') ??
//                       'Stability: Your vegetable health patterns are within the normal range.'),
//               style: TextStyle(
//                   fontSize:   13,
//                   color:      isHigh ? Colors.red : Colors.green,
...
//         children: [
//           Text(
//             appLoc?.translate('Health Risk Trend') ?? 'Health Risk Trend',
//             style: TextStyle(
//                 fontSize:   18,
//                 fontWeight: FontWeight.bold,
//                 color: isDark
...
//           SizedBox(
//               height: 180,
//               child: TrendChart(data: data, isDark: isDark)),
//           const SizedBox(height: 10),
//           Text(
//             appLoc?.translate(
//                     'Moving average showing disease detection rate.') ??
//                 'Moving average showing disease detection rate.',
...
//         children: [
//           Text(
//             appLoc?.translate('Current Distribution') ??
...
//           const SizedBox(height: 25),
//           _buildLegendRow(
//             appLoc?.translate('Healthy')  ?? 'Healthy',
//             healthyPct,
//             Colors.green.shade400,
//             appLoc?.translate('Diseased') ?? 'Diseased',
//             diseasedPct,
//             Colors.red.shade400,
//             isDark,
//           ),
...
//     String label1, double val1, Color col1,
//     String label2, double val2, Color col2,
//     bool isDark,
//   ) {
//     return Row(
...
//   Widget _legendItem(
//       String label, double val, Color color, bool isDark) {
//     return Row(
//       children: [
//         Container(
//             width:  12,
...
//           Text(
//             appLoc?.translate(
//                     'No scan history found for vegetables.') ??
//                 'No scan history found for vegetables.',
//             style: TextStyle(
...
// lib/features/history/presentation/insights_screen.dart
          ...
          : totalScans == 0
              ...
              : isWide
                  ? Center(
                      child: ConstrainedBox(
                        constraints: const BoxConstraints(maxWidth: 720),
                        child: _buildScrollContent(isDark, appLoc, trendData),
                      ),
                    )
                  : _buildScrollContent(isDark, appLoc, trendData),
    );
