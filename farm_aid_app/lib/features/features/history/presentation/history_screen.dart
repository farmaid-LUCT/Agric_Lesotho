...
//   int? _diagnosisId(Map<String, dynamic> item) => item['id'] as int?;
...
//       item['treatment_outcome'] == null && item['id'] != null;
...
//           // ── DESKTOP: centered dialog-style sheet ──────────────
//           ? Center(
//               child: Container(
//                 width: 560,
...
//                       item, isDark, appLoc, needsFeedback),
//                 ),
//               ),
//             )
...
//       children: [
//         // Handle (mobile only visual, harmless on desktop)
//         Center(
//           child: Container(
//             width: 40,
//             height: 4,
...
//               _chip('⚠️ ${item['severity']}',
//                   _severityColor(item['severity']), isDark),
...
//               label: const Text('Give Treatment Feedback',
//                   style: TextStyle(
...
//             label: Text(
//               appLoc?.translate('Export This Report') ?? 'Export This Report',
...
//         children: [
//           pw.Text(
//             appLoc?.translate('FarmAid Individual Diagnosis Report') ??
...
//                 child: _buildBodyContent(isDark, appLoc),
//               ),
//             )
//           // ── MOBILE: full width ─────────────────────────────────
//           : _buildBodyContent(isDark, appLoc),
//     );
//   }

//   Widget _buildBodyContent(bool isDark, AppLocalizations? appLoc) {
//     return Column(
//       children: [
//         // Search bar
//         Padding(
...
//               hintText: appLoc?.translate('Search vegetable scans...') ??
...
//                         final hasFeedback = !_needsFeedback(item);
    ...
    return Scaffold(
      ...
      body: isWide
          ? Center(
              child: ConstrainedBox(
                constraints: const BoxConstraints(maxWidth: 720),
                child: _buildBodyContent(isDark, appLoc, pendingFeedback),
              ),
            )
          : _buildBodyContent(isDark, appLoc, pendingFeedback),
    );
  }

  Widget _buildBodyContent(bool isDark, AppLocalizations? appLoc, int pendingFeedback) {
    return Column(
      children: [
        // ── Floating header row (back + title + actions) ────────
        SafeArea(
          bottom: false,
          child: Padding(
