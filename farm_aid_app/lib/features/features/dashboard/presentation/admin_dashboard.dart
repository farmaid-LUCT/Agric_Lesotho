...
//               const Text('Manage crop data, AI models and farmer accounts.',
...
//                   ),
//                   children: [
//                     // Each card now navigates to its own distinct destination
//                     _AdminCard(
//                       title: 'Knowledge Base',
//                       subtitle: 'Manage Diseases',
//                       icon: Icons.menu_book_rounded,
//                       onTap: () => _launchAdminSection(context, 'knowledgebase/knowledgebase/'),
//                     ),
//                     _AdminCard(
//                       title: 'AI Models',
//                       subtitle: 'Validate Versions',
//                       icon: Icons.psychology_rounded,
//                       onTap: () => _launchAdminSection(context, 'api/aimodel/'),
//                     ),
//                     _AdminCard(
//                       title: 'Personalized Rules',
//                       subtitle: 'Manage Rule Engine',
//                       icon: Icons.rule_rounded,
//                       onTap: () => _launchAdminSection(context, 'api/personalizedrule/'),
//                     ),
//                     _AdminCard(
//                       title: 'User Profiles',
//                       subtitle: 'Manage Farmers',
//                       icon: Icons.people_alt_rounded,
//                       onTap: () => _launchAdminSection(context, 'api/farmer/'),
//                     ),
//                     _AdminCard(
//                       title: 'Market Prices',
//                       subtitle: 'Update Prices',
//                       icon: Icons.monetization_on_outlined,
//                       onTap: () => _launchAdminSection(context, 'api/marketprice/'),
//                     ),
//                     _AdminCard(
//                       title: 'App Alerts',
//                       subtitle: 'Broadcast Alerts',
//                       icon: Icons.campaign_outlined,
//                       onTap: () => _launchAdminSection(context, 'api/appalert/'),
//                     ),
//                     _AdminCard(
//                       title: 'Translations',
//                       subtitle: 'Sesotho Cache',
//                       icon: Icons.translate_rounded,
//                       onTap: () => _launchAdminSection(context, 'api/translationcache/'),
//                     ),
//                     _AdminCard(
//                       title: 'Farmer Insights',
//                       subtitle: 'View Analytics',
//                       icon: Icons.analytics_rounded,
//                       onTap: () => _launchAdminSection(context, 'api/farmerinsight/'),
//                     ),
//                   ],
//                 ),
//               ),
...
//   Future<void> _launchAdminSection(BuildContext context, String section) async {
//     final url = Uri.parse('${AppConstants.adminPortalUrl}$section');
//     try {
...
//           const SnackBar(
//             content: Text('Could not open portal. Ensure the backend is running.'),
...
class _AdminDashboardState extends State<AdminDashboard>
  ...
  /// Helper to handle both List and Wrapped Map responses from Django
  List<dynamic> _ensureList(dynamic jsonResponse) {
    if (jsonResponse == null) return [];
    if (jsonResponse is List) return jsonResponse;
    if (jsonResponse is Map) {
      // Check common Django pagination keys
      if (jsonResponse.containsKey('results')) return jsonResponse['results'] as List;
      if (jsonResponse.containsKey('data')) return jsonResponse['data'] as List;
    }
    return [];
  }
  ...
  Future<void> _loadStats() async {
    ...
    try {
      ...
      if (results[0].statusCode == 200) {
        final reports = _ensureList(jsonDecode(results[0].body));
      ...
      if (results[1].statusCode == 200) {
        final alerts = _ensureList(jsonDecode(results[1].body));
      ...
      if (results[2].statusCode == 200) {
        profiles = _ensureList(jsonDecode(results[2].body)).length;
      }
