              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // FIX: Expanded prevents the Column from overflowing
                      // when disease name is long on narrow screens
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ── Header ─────────────────────────────────────────
                  // FIX: was Row(mainAxisAlignment: spaceBetween, children:[Column, circle])
                  // The unconstrained Column caused the 336px overflow when disease
                  // name was long. Wrap Column in Expanded so it fills available
                  // space and the circle sits flush to the right.
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Expanded(
  ...
  static Widget _buildSection({
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // FIX: wrap title Text in Expanded so long section titles
          // like "RECOMMENDED TREATMENT" don't overflow the Row
          Row(children: [
            Icon(icon, size: 20, color: color),
            const SizedBox(width: 8),
            Expanded(
