...
// import 'package:tflite_web/tflite_web.dart'; // Web-specific AI
...
//   // ✅ 2. Sync Method (Matches your exact implementation)
//   Future<void> syncScanHistory() async {
//     try {
//       final token = await _auth.getToken();
//       if (token == null) throw Exception("No Auth Token found");

//       // Note: Use the Wi-Fi IP we found (10.81.243.167) for local testing
//       final response = await http.get(
//         Uri.parse("http://10.81.243.167:8000/api/farmer-reports/"), 
...
//   // ✅ 3. Main Entry Point for AI Scanning (Laptop Version)
//   static Future<Map<String, dynamic>> runInference(Uint8List imageBytes) async {
//     if (_model == null) await loadModel();

//     // Image Processing (Resizing and Normalizing for Web)
//     img.Image? originalImage = img.decodeImage(imageBytes);
//     if (originalImage == null) return {"label": "Invalid Image", "isRejected": true};

//     img.Image resizedImage = img.copyResize(originalImage, width: 224, height: 224);

//     // Convert image to Float32List (0.0 to 1.0)
...
//     // Prediction using the Web Engine
//     final results = _model!.predict<NamedTensorMap>(floatData);
    
//     // logic to get the best label (Assuming results is a Map of outputs)
//     // For simplicity in the Admin view, we use the first label or a dummy check:
//     String rawResult = _labels != null ? _labels![0] : "Vegetable"; 
