// lib/features/alerts/presentation/widgets/alert_bell_icon.dart
//
// Drop-in bell icon widget for home_dashboard.dart AppBar actions[].
//
// Usage in home_dashboard.dart:
//   import 'package:farm_aid_app/features/alerts/presentation/widgets/alert_bell_icon.dart';
//
//   AppBar(
//     actions: [
//       const AlertBellIcon(),   // ← add this
//       // ...other actions
//     ],
//   )
//
// Behaviour:
//   • Polls /api/alerts/unread-count/ every 60 seconds
//   • Shows red badge with count when unread > 0
//   • Taps navigate to AlertsScreen
//   • Badge disappears after farmer opens alerts (mark-read fires)
